...
export function SessionEndedOverlay({ sessionCode, sessionTitle, closedAt }: SessionEndedOverlayProps) {
  return (
    <div className="absolute inset-0 z-20 flex items-center justify-center bg-background/90 px-4 py-8">
      <Card className="w-full max-w-2xl border-destructive/20 bg-card shadow-lg">
        <CardHeader className="space-y-4 text-center">
          <Badge variant="destructive" className="mx-auto w-fit rounded-lg px-3 py-1 text-xs uppercase tracking-wider">
            Session ended
          </Badge>
